...
void part1()
{
    ...
    zbrak(function1_1, x1, x2, diff, xb1, xb2, &nb);
    printf("Solving Electric circuit design\n");
    printf("======Bisection(rtbis.c)======\n");
    for (i = 1; i <= nb; i++)
    {
        root = rtbis(function1_1, xb1[i], xb2[i], xacc1);
        printf("%dth root with 1e-4: %f\n", i, root);
    }
    printf("\n");
    for (i = 1; i <= nb; i++)
    {
        root = rtbis(function1_1, xb1[i], xb2[i], xacc2);
    ...
    for (i = 1; i <= nb; i++)
    {
        root = rtflsp(function1_1, xb1[i], xb2[i], xacc1);
        printf("%dth root with 1e-4: %f\n", i, root);
    }
    printf("\n");
    for (i = 1; i <= nb; i++)
    {
        root = rtflsp(function1_1, xb1[i], xb2[i], xacc2);
        printf("%dth root with 1e-6: %f\n", i, root);
    }
    ...
    for (i = 1; i <= nb; i++)
    {
        root = rtsec(function1_1, xb1[i], xb2[i], xacc1);
        printf("%dth root with 1e-4: %f\n", i, root);
    }
    printf("\n");
    for (i = 1; i <= nb; i++)
    {
        root = rtsec(function1_1, xb1[i], xb2[i], xacc2);
        printf("%dth root with 1e-6: %f\n", i, root);
    }
    ...
    for (i = 1; i <= nb; i++)
    {
        root = rtnewt(func_final1, xb1[i], xb2[i], xacc1);
        printf("%dth root with 1e-4: %f\n", i, root);
    }
    printf("\n");
    for (i = 1; i <= nb; i++)
    {
        root = rtnewt(func_final1, xb1[i], xb2[i], xacc2);
        printf("%dth root with 1e-6: %f\n", i, root);
    }
    ...
    for (i = 1; i <= nb; i++)
    {
        root = rtsafe(func_final1, xb1[i], xb2[i], xacc1);
        printf("%dth root with 1e-4: %f\n", i, root);
    }
    printf("\n");
    for (i = 1; i <= nb; i++)
    {
        root = rtsafe(func_final1, xb1[i], xb2[i], xacc2);
        printf("%dth root with 1e-6: %f\n", i, root);
    }
    ...
    for (i = 1; i <= nb; i++)
    {
        root = muller(function1_1, xb1[i], xb2[i], xacc1);
        printf("%dth root with 1e-4: %f\n", i, root);
    }
    printf("\n");
    for (i = 1; i <= nb; i++)
    {
        root = muller(function1_1, xb1[i], xb2[i], xacc2);
        printf("%dth root with 1e-6: %f\n", i, root);
    }
}